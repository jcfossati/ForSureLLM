...
## Stack
- **Teacher génération** : Claude Sonnet 4.6 via API (diversité/créativité des phrases)
- **Teacher labeling** : Claude Haiku 4.5 via API (tâche JSON contrainte, 4x moins cher)
